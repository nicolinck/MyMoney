 ...
 * DepenseAmmortie
 *
 * @ORM\Table(name="depenseAmmortie")
 * @ORM\Entity(repositoryClass="NLK\MyMoneyBundle\Repository\DepenseAmmortieRepository")
 */
class DepenseAmmortie extends Depense
{
