...
class RentreeAmmortieType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('name')
            ->add('montant')
            ->add('exerciceDebut', EntityType::class, array(
            ...
            ->add('exerciceFin', EntityType::class, array(
                'class'        => 'NLKMyMoneyBundle:Exercice',
                'query_builder' => function(ExerciceRepository $er)
                                   {
                                        return $er->getListExercices();
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'NLK\MyMoneyBundle\Entity\RentreeAmmortie'
        ));
    }
    ...
    {
        return 'nlk_mymoneybundle_rentreeammortie';
    }
